Public Class Reserve_Step_1___VIP__
    Dim move As Boolean = False
    Dim locX, locY As Integer

    Friend orderMovie As Reserve_Step_1___STD__.Order
    ...
    Private Sub btnCancel_Click(sender As Object, e As EventArgs) Handles btnCancel.Click, MnuClose.Click, picClose.Click
        Me.Close()
